...
3. Research via WebSearch (or scripts/perplexity.sh if available) for: oil, S&P futures, VIX, catalysts, earnings, economic calendar, sector momentum, held tickers
